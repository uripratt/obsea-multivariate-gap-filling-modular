...
def plot_gap_example_per_model(df_original: pd.DataFrame, df_filled: pd.DataFrame, 
    ...
    # Context window (+- 100 points or something reasonable)
    try:
    ...
    # Plot the reconstruction only for the gap region to highlight it
    # But we plot it across the whole window for continuity, using a different style
