...
def interpolate_xgboost(df: pd.DataFrame, target_var: str, predictor_vars: List[str] = None, max_gap_size: int = None):
    try:
...
def interpolate_xgboost_pro(df: pd.DataFrame, target_var: str, predictor_vars: List[str] = None, max_gap_size: int = None):
    try:
