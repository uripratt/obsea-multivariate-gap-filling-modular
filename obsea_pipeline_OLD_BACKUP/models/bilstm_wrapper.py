...
def interpolate_bilstm(df: pd.DataFrame, target_var: str, predictor_vars: list = None, max_gap_size: int = None, df_train: pd.DataFrame = None):
    ...
    try:
        ...
        imputer.fit(train_data[predictor_vars], verbose=False)
